...
async function main() {
  ...
  console.log(`현재: ${currentMinutes}분, 출근: ${startMinutes}분, 퇴근: ${endMinutes}분`);
  console.log(`출근알림: ${isCheckinAlert}, 퇴근알림: ${isCheckoutAlert}`);
