...
// ── 근로계약서 (관리자) ─────────────────────────────────────────
function EducationAdminTab({ educations, members, reads }) {
      ...
      {showForm && (
        <div style={{ background: T.card, borderRadius: 16, padding: 16, marginBottom: 16, border: `1px solid ${T.border}` }}>
          ...
          <div style={{ marginBottom: 10 }}>
            ...
            <input value={title} onChange={e => setTitle(e.target.value)} placeholder="예: 안전보건교육"
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            ...
            <Btn variant="admin" onClick={submit} disabled={uploading}>{uploading ? "등록 중..." : "📢 개설"}</Btn>
          </div>
        </div>
      )}
  ...
  return (
    <div style={{ minHeight: "100vh", background: T.bg, fontFamily: "'Noto Sans KR',sans-serif", paddingBottom: 30 }}>
      ...
      <div style={{ padding: 16 }}>
        ...
        {isEducationTab && (
          <EducationAdminTab educations={educations} members={members} reads={reads} />
        )}
