...
const APP_VERSION = "v2026.07.13-r11";
                ...
                {OTHER_TEMPLATES.map(t => (
                  <button key={t.key} onClick={() => {
                    if (t.key === "annual_notice") {
                      ...
                      const content = `${fmtDot2(today)} 기준, 귀하의 연차 현황을 아래와 같이 안내드립니다.\n\n■ 총 연차: ${total}일\n■ 사용 연차: ${used}일\n■ 잔여 연차: ${remain}일\n\n[안내사항]\n■ 사용 기한: 잔여 연차는 위 한도 내에서 올해 12월 31일까지 자유롭게 사용하실 수 있습니다.\n■ 이월 불가: 미사용 잔여 연차는 다음 연도로 이월되지 않으니, 계획을 세워 사용해주시기 바랍니다.\n■ 미사용 정산: 연말까지 사용하지 못한 잔여 연차는 일급에 잔여일수를 곱한 금액으로 정산하여 12월 급여에 포함하여 지급해 드립니다.`;
