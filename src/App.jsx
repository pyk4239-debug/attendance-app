...
const APP_VERSION = "v2026.07.13-r10";
                ...
                {OTHER_TEMPLATES.map(t => (
                  <button key={t.key} onClick={() => {
                    if (t.key === "annual_notice") {
                      ...
                      const content = `${fmtDot2(today)} 기준, 귀하의 연차 현황을 아래와 같이 안내드립니다.\n\n■ 총 연차: ${total}일\n■ 사용 연차: ${used}일\n■ 잔여 연차: ${remain}일\n\n잔여 연차는 올해 말일까지 위 한도 내에서 자유롭게 사용하실 수 있습니다.\n미사용 잔여 연차는 다음 연도로 이월되지 않습니다.\n올해 말일까지 미사용한 잔여 연차는 일급에 잔여일수를 곱한 금액으로 정산하여 12월 급여에 포함하여 지급됩니다.`;
