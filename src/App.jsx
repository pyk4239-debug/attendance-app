...
const APP_VERSION = "v2026.07.13-r16";
...
const OTHER_TEMPLATES = [
  { key: "dismissal", label: "해고통지서",
    content: `본 통지서는 근로기준법 제27조에 따라 해고사유와 해고시기를 서면으로 통지하기 위해 작성되었습니다.\n\n■ 본 통지서 도달일: 년 월 일\n■ 해고 예정일(효력 발생일): 년 월 일\n\n■ 해고 사유:\n(구체적인 사실관계와 사유를 기재해주세요)\n\n■ 해고예고(근로기준법 제26조) 관련 — 해당 사항에 표기\n[ ] 해고 예정일 30일 이상 전에 예고함 (예고수당 없음)\n[ ] 예고기간이 30일에 미달하여 부족한 일수만큼 예고수당(통상임금 기준) 지급함 — 금액/산정근거:\n[ ] 근로기준법 제26조 단서 사유에 해당하여 예고 없이 시행함 — 구체 사유:\n\n위 사유로 상기 일자부로 근로계약을 해지함을 통지합니다.` },
